...
-- To compile:
--
--     shell> ghc (-O2) -i:"../" ./THIS_FILE.hs
--
-- For more details, see The Journal of Chemical Physics 139, 044118(2013).
------------------------------------------------------------------------------------------------------------------------
...
main = do
  let
    ...
    k = sfIndex "k" Active  Dummy      
    c = sfIndex "c" Virtual Dummy           
    l = sfIndex "l" Active  Dummy      
    d = sfIndex "d" Virtual Dummy
    
    p = sfIndex "p" Generic Dummy      
    q = sfIndex "q" Generic Dummy           
    r = sfIndex "r" Generic Dummy      
    s = sfIndex "s" Generic Dummy           
